...
(function () {
  ...
  const P = {
    ...
    'rotate-ccw':   '<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.49"/>',
    ...
    'book-marked':  '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20l-7-3-7 3V2z"/>',
  ...
  SR.icons = {
    get(name, cls) {
      ...
      return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon ${cls}" aria-hidden="true">${paths}</svg>`;
    },
  };
})();
