  ...
  SR.renderSettings = function (container, navigate) {
    ...
    container.innerHTML = `
      <div class="screen fade-scale-in">
        ...
        <!-- Typing -->
        <div class="settings-section">
          <p class="text-micro settings-section-title">Typing</p>
          <div class="list">
            <div class="list-row" style="justify-content:space-between;padding:16px 20px">
              <div>
                <p class="text-body-sm" style="font-weight:600">App Keyboard</p>
                <p class="text-caption">Show built-in keyboard during practice</p>
              </div>
              ${tog(s.useAppKeyboard, 'tog-appkb', 'Use app keyboard')}
            </div>
            <div class="list-row" style="justify-content:space-between;padding:16px 20px">
              <div>
                <p class="text-body-sm" style="font-weight:600">Haptic Feedback</p>
                <p class="text-caption">Light vibration on key press</p>
              </div>
              ${tog(s.hapticFeedback, 'tog-haptic', 'Haptic feedback')}
            </div>
          </div>
        </div>
    ...
    /* Typing toggles */
    wireTog('tog-appkb', 'useAppKeyboard', function(val) {
      try {
        document.dispatchEvent(new CustomEvent('spellright:appkeyboard', { detail: val }));
      } catch(_) {}
    });
    wireTog('tog-haptic', 'hapticFeedback');
