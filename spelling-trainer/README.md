...
During practice sessions a built-in QWERTY keyboard appears on screen.
You never need to use your device's native keyboard.

- Tap any letter key to type it into the input field
- Tap **⌫** to delete the last character
- Hold **⌫** to continuously delete (like a smartphone keyboard)
- Press **Enter** on a physical keyboard (desktop) to submit — this still works

The keyboard is fully theme-aware and updates instantly when you change the
accent colour or switch between light and dark mode.
